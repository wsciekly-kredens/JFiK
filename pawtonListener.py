...
class pawtonListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by pawtonParser#simpleAssign.
    def enterSimpleAssign(self, ctx: pawtonParser.SimpleAssignContext):
        pass

    # Exit a parse tree produced by pawtonParser#simpleAssign.
    def exitSimpleAssign(self, ctx: pawtonParser.SimpleAssignContext):
        pass
    ...
    # Enter a parse tree produced by pawtonParser#ifStat.
    def enterIfStat(self, ctx: pawtonParser.IfStatContext):
        pass

    # Exit a parse tree produced by pawtonParser#ifStat.
    def exitIfStat(self, ctx: pawtonParser.IfStatContext):
        pass

    # Enter a parse tree produced by pawtonParser#forstat.
    def enterForstat(self, ctx: pawtonParser.ForstatContext):
        pass

    # Exit a parse tree produced by pawtonParser#forstat.
    def exitForstat(self, ctx: pawtonParser.ForstatContext):
        pass
    ...
    # Enter a parse tree produced by pawtonParser#Compare.
    def enterCompare(self, ctx: pawtonParser.CompareContext):
        pass

    # Exit a parse tree produced by pawtonParser#Compare.
    def exitCompare(self, ctx: pawtonParser.CompareContext):
        pass
